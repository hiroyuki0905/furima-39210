class Item < ApplicationRecord
  ...
  validates :condition_id, presence: { message: "を入力してください"}

  validates :delivery_fee_id, presence: { message: "を入力してください"}
  validates :prefecture_id, presence: { message: "を入力してください"}
  validates :delivery_day_id, presence: { message: "を入力してください"}
  validates :price, presence: true,
                    numericality: { only_integer: true, greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999 }
  validates :image, presence: { message: "を選択してください"}, unless: :was_attached?
